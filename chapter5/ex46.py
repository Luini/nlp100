...
if __name__ == "__main__":
    ...
    pairs = [
        [chunk.getPredicate(), [[sentence[src].getPostposition(), sentence[src].getSurface()] for src in chunk.srcs if sentence[src].isContainPostposition()]]
    ...
    pairs = [
        [pair[0], [p[0] for p in pair[1]], [p[1] for p in pair[1]]]
        for pair in pairs
    ]
    for pair in pairs:
